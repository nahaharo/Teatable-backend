...
mod tests {
    ...
    #[test]
    fn old_combination() {
        let a = SubjectResponse::from_file("foo.txt".to_string());
        ...
        let fix_subs = vec![];
        let mut req_subs = vec!["SE102a".to_string(), "SE105a".to_string(), "SE106".to_string(), "SE108a".to_string(), "SE109".to_string(), "SE111".to_string(), "SE112".to_string(), "SE118".to_string()];
        let mut sel_subs = vec![];
